...
// V1.2 期限识别收紧：中文钟点（三点/九点）必须带时段前缀（下午/今晚…）或 之?前/以内 后缀，
// 否则"好一点/多一点"这类量词会冒充期限（真实语料里"小确幸日记"一度刷出上百条假承诺）。
const DEADLINE_RE = /((今天|明天|后天|今晚|明早|本周|下周|月底|月初|周[一二三四五六日天]|星期[一二三四五六日天])\s*(之?前|以内))|((今天|明天|后天|今晚|明早|早上|上午|中午|下午|晚上|夜里|凌晨)\s*[零一二两三四五六七八九十]{1,3}\s*点(\s*(之?前|以内))?)|([零一二两三四五六七八九十]{1,3}\s*点\s*(之?前|以内))|(\d{1,2}\s*点(\s*(之?前|以内))?)|(\d{1,2}\s*[号日](\s*(之?前|以内))?)/;
